                ...
                <tbody>
                    @foreach ($ekstras as $key => $ekstra)
                        <tr>
                            ...
                            <td>
                                {{-- DETAIL --}}
                                <a href="{{ route('admin.ekstra.show', $ekstra->id) }}"
                                ...
                                {{-- HAPUS --}}
                              <a href="javascript:void(0)" onclick="handleDestroy('{{ route('admin.ekstra.destroy', $ekstra->id) }}')" class="btn btn-link text-danger p-0 mx-1" title="Hapus">
